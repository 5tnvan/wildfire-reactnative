...
export default function SkortPage() {
  ...
  return (
    <View
      className="relative bg-red-300 flex-1 justify-between"
      style={{
        width: windowWidth,
        height: windowHeight,
      }}>
        {/* <ImageBackground
        source={require('@/assets/images/screenshoot-01.png')}
        className="bg-cover"
      >
      </ImageBackground> */}

      {/* SKORT TOP */}
      <View className="flex flex-row items-center justify-between pt-14 px-3">
        <View className='flex-row items-center'>
          <LogoWildfireLit />
          <Text className='text-lg text-white font-semibold ml-2'>Is there extraterrestrial...</Text>
        </View>
        <PressableSkort />
      </View>
      ...
      {/* SKORT BOTTOM RIGHT */}
      <View className='absolute bottom-36 right-3 flex-col items-center justify-end'>
